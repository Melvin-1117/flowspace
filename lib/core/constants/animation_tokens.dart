...
// ──────────────────────────────────────────────────────────────────────────────
const Duration kMicroDuration = kIsWeb ? Duration(milliseconds: 50) : Duration(milliseconds: 150);
const Curve kMicroCurve = Curves.easeOut;

// ──────────────────────────────────────────────────────────────────────────────
// Component mount  (modals appearing, cards switching, content fading in)
// ──────────────────────────────────────────────────────────────────────────────
const Duration kMountDuration = kIsWeb ? Duration(milliseconds: 80) : Duration(milliseconds: 250);
const Curve kMountCurve = Curves.easeOut;

// ──────────────────────────────────────────────────────────────────────────────
// Component unmount  (reverse of mount — slightly faster to feel snappy)
// ──────────────────────────────────────────────────────────────────────────────
const Duration kUnmountDuration = kIsWeb ? Duration(milliseconds: 60) : Duration(milliseconds: 200);
const Curve kUnmountCurve = Curves.easeIn;

// ──────────────────────────────────────────────────────────────────────────────
// Page-level staggered entry  (cards cascading in on screen open)
// ──────────────────────────────────────────────────────────────────────────────
const Duration kPageEntryDuration = kIsWeb ? Duration(milliseconds: 100) : Duration(milliseconds: 300);
const Curve kPageEntryCurve = Curves.easeInOut;

/// Delay increment between successive staggered items.
const Duration kPageStaggerStep = kIsWeb ? Duration.zero : Duration(milliseconds: 80);

// ──────────────────────────────────────────────────────────────────────────────
// Data visualisation / chart reveals
// ──────────────────────────────────────────────────────────────────────────────
const Duration kChartDuration = kIsWeb ? Duration(milliseconds: 200) : Duration(milliseconds: 800);
