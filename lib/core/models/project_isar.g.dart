...
void _projectSerialize(
  ...
  writer.writeStringList(offsets[1], object.memberIds);
...
Project _projectDeserialize(
  ...
  object.id = id;
  object.memberIds = reader.readStringList(offsets[1]) ?? [];
...
extension ProjectByIndex on IsarCollection<Project> {
  ...
  Project? getByUuidSync(String uuid) {
  ...
  Future<List<Project?>> getAllByUuid(List<String> uuidValues) {
    final values = uuidValues.map((e) => [e]).toList();
    return getAllByIndex(r'uuid', values);
  }

  List<Project?> getAllByUuidSync(List<String> uuidValues) {
    final values = uuidValues.map((e) => [e]).toList();
  ...
  Future<Id> putByUuid(Project object) {
    return putByIndex(r'uuid', object);
  }

  Id putByUuidSync(Project object, {bool saveLinks = true}) {
    return putByIndexSync(r'uuid', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByUuid(List<Project> objects) {
    return putAllByIndex(r'uuid', objects);
  }

  List<Id> putAllByUuidSync(List<Project> objects, {bool saveLinks = true}) {
...
extension ProjectQueryWhere on QueryBuilder<Project, Project, QWhereClause> {
  ...
  QueryBuilder<Project, Project, QAfterWhereClause> uuidEqualTo(String uuid) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<Project, Project, QAfterWhereClause> uuidNotEqualTo(
    String uuid,
  ) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
...
extension ProjectQueryFilter
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> memberIdsElementEqualTo(
    String value, {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> memberIdsElementBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> memberIdsElementMatches(
    String pattern, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> memberIdsLengthEqualTo(
    int length,
  ) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> memberIdsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'memberIds', 0, true, 0, true);
    });
  }

  QueryBuilder<Project, Project, QAfterFilterCondition> memberIdsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'memberIds', 0, false, 999999, true);
    });
  }

  QueryBuilder<Project, Project, QAfterFilterCondition> memberIdsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> memberIdsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> uuidEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> uuidGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> uuidLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> uuidBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> uuidStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> uuidEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> uuidContains(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> uuidMatches(
    String pattern, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> uuidIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> uuidIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
...
extension ProjectQuerySortBy on QueryBuilder<Project, Project, QSortBy> {
  ...
  QueryBuilder<Project, Project, QAfterSortBy> sortByUuid() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'uuid', Sort.asc);
    });
  }

  QueryBuilder<Project, Project, QAfterSortBy> sortByUuidDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ProjectQuerySortThenBy
  ...
  QueryBuilder<Project, Project, QAfterSortBy> thenByUuid() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'uuid', Sort.asc);
    });
  }

  QueryBuilder<Project, Project, QAfterSortBy> thenByUuidDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'uuid', Sort.desc);
    });
  }
...
extension ProjectQueryWhereDistinct
  ...
  QueryBuilder<Project, Project, QDistinct> distinctByMemberIds() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, Project, QDistinct> distinctByUuid({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension ProjectQueryProperty
  ...
  QueryBuilder<Project, List<String>, QQueryOperations> memberIdsProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Project, String, QQueryOperations> uuidProperty() {
    return QueryBuilder.apply(this, (query) {
